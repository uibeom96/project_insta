...
DATABASES = {
    'default': {
        ...
        'NAME':     get_secret_key("secret_deploy_NAME"),
        "USER":     get_secret_key("secret_deploy_USER"),
        "PASSWORD": get_secret_key("secret_deploy_PASSWORD"),
        "HOST":     get_secret_key("secret_deploy_HOST"),
