...
class Post(BaseModel):
    ...
    dis_like = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name="dis_likes") 
    follower = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name="followers")
    following = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name="followings")
